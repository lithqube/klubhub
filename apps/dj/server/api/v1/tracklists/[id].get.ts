...
const MOCK_TRACKLISTS: Record<string, any> = {
  ...
  'tl-002': { id: 'tl-002', title: 'TRESOR CLOSING SET', sourceFormat: 'rekordbox', rawFilePath: null, preset: 'dark', visibleFields: ['title', 'artist', 'bpm', 'key', 'durationSecs'], bgMode: 'solid', bgValue: null, maxTracks: 31, trackRangeStart: null, trackRangeEnd: null, createdAt: '2026-03-08T02:00:00Z', updatedAt: '2026-03-08T04:30:00Z' },
  ...
  'tl-004': { id: 'tl-004', title: 'FABRIC ROOM 1 PREP', sourceFormat: 'traktor', rawFilePath: null, preset: 'dark', visibleFields: ['title', 'artist', 'bpm', 'key', 'durationSecs'], bgMode: 'solid', bgValue: null, maxTracks: 60, trackRangeStart: null, trackRangeEnd: null, createdAt: '2026-02-18T10:00:00Z', updatedAt: '2026-02-18T11:30:00Z' },
}
